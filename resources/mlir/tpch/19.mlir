module {
  func.func @main() -> !dsa.table {
    ...
    %4 = relalg.map %3 computes : [@map0::@tmp_attr1({type = !db.decimal<30, 4>})] (%arg0: !relalg.tuple){
    ...
    %5 = relalg.aggregation %4 [] computes : [@aggr0::@tmp_attr0({type = !db.nullable<!db.decimal<30, 4>>})] (%arg0: !relalg.tuplestream,%arg1: !relalg.tuple){
      %7 = relalg.aggrfn sum @map0::@tmp_attr1 %arg0 : !db.nullable<!db.decimal<30, 4>>
      relalg.return %7 : !db.nullable<!db.decimal<30, 4>>
    }
